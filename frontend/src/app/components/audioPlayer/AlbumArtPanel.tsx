...
const AlbumArtPanel: React.FC<AlbumArtPanelProps> = ({ track, show }) => {
  ...
  return (
    <div 
      className={`fixed bottom-0 left-0 w-64 bg-white shadow-lg border-t border-r border-gray-200 transform transition-transform duration-300 z-10 ${
        show ? 'translate-y-0' : 'translate-y-full'
      }`}
      style={{ height: '320px' }} // Fixed height for consistency
    >
      {/* Album Art Display */}
